<html>
    <head prefix="og: http://ogp.me/ns# fb: http://ogp.me/ns/fb# cscibigtwo: http://ogp.me/ns/fb/cscibigtwo#">
        <title>Room - <?php echo $_REQUEST['name'];?></title>
    ...
    <script type="text/javascript">
      window.location.href="http://apps.facebook.com/cscibigtwo";
    </script>

    <body>
        Hang tight, we are getting you to the game.
    </body>
</html>
